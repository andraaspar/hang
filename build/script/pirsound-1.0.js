...
(function (pirsound) {
    var Main = (function () {
        ...
        Main.onDOMLoaded = function () {
            ...
            var wave1Bezier = pirsound.path.SVGPathConverter.convert(Main.test1Document.getElementById('wave-1').getAttribute('d'));
            var wave1Linear = wave1Bezier.linearize(1);
            var wave1 = new pirsound.wave.PathWave(wave1Linear);

            var sineWave = new pirsound.wave.SineWave();
            var squareWave = new pirsound.wave.SquareWave();
            var freqWave = new pirsound.wave.ConstantWave(30);
            var multiplyWave = new pirsound.wave.MultiplyWave(pathWave, .1);
            var multiplyWave2 = new pirsound.wave.MultiplyWave(multiplyWave, .5);
            var multiplyWave3 = new pirsound.wave.MultiplyWave(multiplyWave, 1.5);
            var levelWave = new pirsound.wave.ConstantWave(100);
            var snd = new pirsound.sound.Sound(wave1, multiplyWave, levelWave, 5);
            var snd2 = new pirsound.sound.Sound(wave1, multiplyWave2, levelWave, 5);
            var snd3 = new pirsound.sound.Sound(wave1, multiplyWave3, levelWave, 5);
            var snd4 = new pirsound.sound.Sound(wave1, freqWave, levelWave, 5);
            var mixer = new pirsound.sound.Mixer([snd, snd2]);
            mixer.render();
